// DONE   :::   remove all the sanity checks, as sir already told to assume, and in testcases,
// DONE   :::   remove int main()
// DONE   :::   remove extra functions,,,print waale

// DONE   :::    RECURSION, RECURSION andd RECURSION!
// DONE   :::    base case for all functions  is           if(!top_left) blah...

// DONE   :::   major flaw, if we revert the changes, children are not deleted....write a function regulate()???
// DONE   :::   wrote regulate() for this.... DONE.
...
class quad_tree {
	...
	int value;  //0 or 1
	int n = 0;  // n is height which power of 2. does this quad_tree === submatrix refer to..
	long long int  num_1;
